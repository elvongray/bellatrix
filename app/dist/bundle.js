...
/******/ 	var hotCurrentHash = "d671fb9dbf647a0a1d4b"; // eslint-disable-line no-unused-vars
...
/******/ 	__webpack_require__.p = "http://localhost:8080/app/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _context_menu = __webpack_require__(161);

	var _actionsGeneralActions = __webpack_require__(162);

	var _actionsGeneralActions2 = _interopRequireDefault(_actionsGeneralActions);

	var _storesAppStore = __webpack_require__(167);

	var _storesAppStore2 = _interopRequireDefault(_storesAppStore);

	var _containersEditorContainer = __webpack_require__(170);

	var _containersEditorContainer2 = _interopRequireDefault(_containersEditorContainer);

	var ipc = window.require('ipc');

	var Bellatrix = (function (_React$Component) {
	  _inherits(Bellatrix, _React$Component);

	  function Bellatrix(props) {
	    _classCallCheck(this, Bellatrix);

	    _get(Object.getPrototypeOf(Bellatrix.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(Bellatrix, [{
	    key: 'changeLanguage',
	    value: function changeLanguage(language) {
	      _actionsGeneralActions2['default'].loadSavedEditorText(language);
	      this.setState({
	        language: language
	      });
	    }
	  }, {
	    key: 'changeEditorTheme',
	    value: function changeEditorTheme(theme) {
	      this.setState({
	        theme: theme
	      });
	    }
	    ...
	    value: function componentWillMount() {
	      ...
	      */
	      ...
	      (0, _context_menu.contextMenu)();

	      ipc.on('change-theme', function (theme) {
	        _this.changeEditorTheme(theme);
	        _actionsGeneralActions2['default'].saveCurrentState(_this.state);
	      });
	      ...
	      _storesAppStore2['default'].addLoadSavedStateListener(this.loadSavedState.bind(this));

	      // Register method for changing language
	      _storesAppStore2['default'].addChangeLanguageListener(this.changeLanguage.bind(this));
	    }
	  }, {
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      // trigger action to load the saved state
	      _actionsGeneralActions2['default'].loadSavedState();
	    }
	  }, {
	    key: 'getEditorText',
	    value: function getEditorText(text) {
	      this.setState({
	        editorText: text
	      });
	    }
	    ...
	    key: 'loadSavedState',
	    value: function loadSavedState(state) {
	      this.setState(state);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(_containersEditorContainer2['default'], {
	...
	_reactDom2['default'].render(_react2['default'].createElement(Bellatrix, null), document.getElementById('bellatrix'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GeneralActions = {
	  ...
	  changeLanguage: function changeLanguage(langauge) {
	  ...
	  saveCurrentState: function saveCurrentState(state) {
	  ...
	  saveEditorText: function saveEditorText(text, language) {
	  ...
	  loadSavedEditorText: function loadSavedEditorText(language) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppStore = (0, _objectAssign2['default'])({}, _events.EventEmitter.prototype, {
	  ...
	  emitChangeLanguage: function emitChangeLanguage(language) {
	    this.emit('change_language', language);
	  },

	  addChangeLanguageListener: function addChangeLanguageListener(callback) {
	    this.on('change_language', callback);
	  },

	  emitLoadSavedState: function emitLoadSavedState(data) {
	    this.emit('load_saved_state', data);
	  },

	  addLoadSavedStateListener: function addLoadSavedStateListener(callback) {
	    this.on('load_saved_state', callback);
	  },

	  emitLoadSavedText: function emitLoadSavedText(data) {
	    this.emit('load_saved_text', data);
	  },

	  addLoadSavedTextListener: function addLoadSavedTextListener(callback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TextEditorContainer = __webpack_require__(171);

	var _TextEditorContainer2 = _interopRequireDefault(_TextEditorContainer);

	var _TerminalContainer = __webpack_require__(194);

	var _TerminalContainer2 = _interopRequireDefault(_TerminalContainer);

	var _MarkdownContainer = __webpack_require__(199);

	var _MarkdownContainer2 = _interopRequireDefault(_MarkdownContainer);

	var _componentsDraggableDiv = __webpack_require__(203);

	var _componentsDraggableDiv2 = _interopRequireDefault(_componentsDraggableDiv);
	...
	var EditorContainer = (function (_React$Component) {
	  ...
	  _createClass(EditorContainer, [{
	    ...
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.terminalDomNode = _reactDom2['default'].findDOMNode(this.refs.terminal);
	      this.editorDomNode = _reactDom2['default'].findDOMNode(this.refs.editor);
	    }
	  }, {
	    key: 'getElementTransform',
	    value: function getElementTransform(el) {
	    ...
	    value: function render() {
	      ...
	      if (this.props.language === 'markdown') {
	        display = _react2['default'].createElement(_MarkdownContainer2['default'], {
	          editorText: this.props.editorText });
	      } else {
	        display = _react2['default'].createElement(_TerminalContainer2['default'], {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: 'mdl-grid mdl-grid--no-spacing editor-container' },
	        _react2['default'].createElement(
	          'div',
	          { ref: 'editor', className: 'mdl-cell mdl-cell--6-col text-editor' },
	          _react2['default'].createElement(_TextEditorContainer2['default'], {
	            theme: this.props.theme,
	            language: this.props.language,
	            getEditorText: this.props.getEditorText })
	        ),
	        _react2['default'].createElement(_componentsDraggableDiv2['default'], null),
	        _react2['default'].createElement(
	          'div',
	          { ref: 'terminal', className: 'mdl-cell mdl-cell--6-col terminal' },
	          display
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTextEditorComponent = __webpack_require__(172);

	var _componentsTextEditorComponent2 = _interopRequireDefault(_componentsTextEditorComponent);
	...
	var TextEditorContainer = (function (_React$Component) {
	  ...
	  function TextEditorContainer(props) {
	    ...
	    _get(Object.getPrototypeOf(TextEditorContainer.prototype), 'constructor', this).call(this, props);
	    this.aceEditor;
	    this.state = {
	  ...
	  _createClass(TextEditorContainer, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      if (nextProps.language !== this.props.language) {
	        _actionsGeneralActions2['default'].loadSavedEditorText(nextProps.language);
	      }
	    }
	  }, {
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      ...
	      _storesAppStore2['default'].addLoadSavedTextListener(this.loadSavedText.bind(this));
	    ...
	    value: function componentDidMount() {
	      ...
	      _actionsGeneralActions2['default'].loadSavedEditorText(this.props.language);
	    }
	  }, {
	    key: 'setUpAceEditor',
	    value: function setUpAceEditor() {
	      var _this2 = this;
	      ...
	      this.aceEditor.getSession().on('change', function (e) {
	        _this2.handleEditorChange(e);
	      });

	      this.aceEditor.selection.on("changeCursor", function () {
	        _this2.setState({
	          cursorPosition: _this2.aceEditor.getCursorPosition()
	        });
	      });
	    }
	    ...
	    key: 'enableLanguageIntellisence',
	    value: function enableLanguageIntellisence() {
	      var _this3 = this;
	    ...
	    key: 'loadSavedText',
	    value: function loadSavedText(text) {
	      this.aceEditor.setValue(text);
	    }
	  }, {
	    key: 'saveEditorText',
	    value: function saveEditorText() {
	      _actionsGeneralActions2['default'].saveEditorText(this.aceEditor.getValue(), this.props.language);
	    }
	  }, {
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(_componentsTextEditorComponent2['default'], {
	        language: this.props.language,
	        getEditorText: this.getEditorText.bind(this),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DropdownComponent = __webpack_require__(173);
	...
	var TextEditorComponent = (function (_React$Component) {
	  _inherits(TextEditorComponent, _React$Component);

	  function TextEditorComponent(props) {
	    _classCallCheck(this, TextEditorComponent);

	    _get(Object.getPrototypeOf(TextEditorComponent.prototype), 'constructor', this).call(this, props);
	  }
	  ...
	  _createClass(TextEditorComponent, [{
	    ...
	    key: 'changeLanguage',
	    value: function changeLanguage(language) {
	      _actionsGeneralActions2['default'].changeLanguage(language.toLowerCase());
	    }
	  }, {
	    key: 'unslugify',
	    value: function unslugify(string) {
	    ...
	    key: 'render',
	    value: function render() {
	      var languages = ['JAVASCRIPT', 'RUBY', 'COFFEESCRIPT', 'MARKDOWN'];

	      return _react2['default'].createElement(
	        'div',
	        { className: 'mdl-layout mdl-js-layout mdl-layout--fixed-header text-editor-container' },
	        _react2['default'].createElement(
	          'header',
	          { className: 'mdl-layout__header text-editor-header' },
	          _react2['default'].createElement(
	            'div',
	            ...
	            _react2['default'].createElement(
	              'button',
	              {
	                ...
	                ref: 'runButton' },
	              'Run',
	              _react2['default'].createElement('i', { className: 'fa fa-caret-right icon' })
	            )
	          )
	        ),
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              null,
	              'Line ',
	              this.props.cursorPosition.row + 1,
	              ', '
	            ),
	            _react2['default'].createElement(
	              'span',
	              null,
	              'Column ',
	              this.props.cursorPosition.column + 1
	            )
	          ),
	          _react2['default'].createElement(
	            'div',
	            ...
	            'Theme: ',
	            this.unslugify(this.props.theme)
	          )
	        )
	      );
	    }
	...
	exports['default'] = TextEditorComponent;
	module.exports = exports['default'];
	/* TODO: This header should be a component */ /* TODO: This footer should be a component */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDdMenu = __webpack_require__(174);
	...
	var DropdownComponent = (function (_React$Component) {
	  ...
	  function DropdownComponent(props) {
	    ...
	    _get(Object.getPrototypeOf(DropdownComponent.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      isOpen: false
	    };
	  }
	    ...
	    value: function render() {
	      ...
	      var menuOptions = {
	        ...
	        toggle: _react2['default'].createElement(
	          'button',
	          { type: 'button', className: 'mdl-button mdl-js-button select-dropdown-toggle',
	            onClick: this.toggle.bind(this) },
	          _react2['default'].createElement(
	            'span',
	            { className: 'select-dropdown-toggle-text' },
	            this.props.language
	          ),
	          _react2['default'].createElement('i', { className: 'fa fa-caret-down dropdown-icon' })
	        ),
	        align: 'center',
	      ...
	      return _react2['default'].createElement(
	        ...
	        this.props.languages.map(function (language) {
	          return _react2['default'].createElement(
	            'li',
	            { key: _this.props.languages.indexOf(language) },
	            _react2['default'].createElement(
	              'button',
	              { type: 'button', onClick: _this.click.bind(_this, language) },
	              language
	            )
	          );
	        })
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".select-dropdown-toggle {\n  width: 150px;\n  position: relative;\n  height: 25px;\n  border: 1px #616161 solid;\n}\n\n.select-dropdown-toggle-text {\n  position: absolute;\n  color: white;\n  font-size: 14px;\n  text-align: center;\n  left: 10px;\n  top: -6px;\n  height: 20px;\n}\n\n.dropdown-icon {\n  position: absolute;\n  color: white;\n  right: 10px;\n  top: 5px;\n}\n\n.dd-menu-items ul {\n  background-color: #2d353c !important;\n}\n\n.dd-menu-items ul li {\n  color: #ffffff;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".text-editor {\n  height: 100%;\n  width: 50%;\n  position: relative;\n}\n\n.text-editor-container {\n  position: relative;\n  width: 100%;\n  overflow: hidden;\n}\n\n.text-editor-header {\n  position: relative;\n  width: 100%;\n  min-height: 20px;\n  color: #E0E0E0;\n  background-color: #22282E !important;\n}\n\n.text-editor-header .mdl-layout__header-row {\n  height: 33px;\n}\n\n.text-editor-header\n.mdl-layout__header-row\n.mdl-layout-title {\n  font-size: 14px;\n  text-transform: uppercase;\n}\n\n.text-editor-button {\n  position: absolute;\n  right: 30px;\n  top: 4px;\n  height: 25px;\n  font-size: 10px;\n  text-align: center;\n  line-height: 20px;\n  color: #E0E0E0;\n  border: 1px #616161 solid;\n  border-radius: 3px;\n  margin-left: 20px;\n}\n\n.run-button {\n  background-color: #51b9b0;\n  border: 0px;\n}\n\n#editor {\n  position: relative;\n  margin-top: 0px;\n  margin-bottom: 0px;\n  width: 100%;\n  height: 100%;\n  font-size: 14px;\n  font-family: Menlo, 'Ubuntu Mono', Monaco, Consolas, source-code-pro, monospace;\n}\n\n.icon {\n  margin-left: 6px;\n}\n\n.cursor-position {\n  font-size: 12px;\n  color: #757575;\n  float: left;\n  margin-left: 15px;\n}\n\n.editor-theme {\n  color: #757575;\n  font-size: 12px;\n  margin-right: 10px;\n  float: right;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTerminalComponent = __webpack_require__(195);

	var _componentsTerminalComponent2 = _interopRequireDefault(_componentsTerminalComponent);

	var _lang_configLanguage = __webpack_require__(198);

	var TerminalContainer = (function (_React$Component) {
	  _inherits(TerminalContainer, _React$Component);

	  function TerminalContainer(props) {
	    _classCallCheck(this, TerminalContainer);

	    _get(Object.getPrototypeOf(TerminalContainer.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      showSpinner: true
	    };
	    this.jqconsole;
	  ...
	  _createClass(TerminalContainer, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      var inputCallback = function inputCallback(callback) {
	        _this.jqconsole.Input(function (result) {
	          callback(result);
	        });
	      };

	      var outputCallback = function outputCallback(string) {
	        _this.jqconsole.Write(string.trimRight() + '\n', 'jqconsole-output');
	      };

	      var resultCallback = function resultCallback(string) {
	        if (string) {
	          _this.jqconsole.Write('=> ' + string + '\n', 'jqconsole-output');
	        }
	      };

	      var errorCallback = function errorCallback(string) {
	        _this.jqconsole.Write(string + '\n', 'jqconsole-error');
	      };

	      var progressCallback = function progressCallback(m, n) {
	        // Will use later ¯\_(ツ)_/¯
	      };

	      var timeoutCallback = function timeoutCallback() {
	        _this.loadLanguage(_this.props.language);
	        return true;
	      };
	    ...
	    value: function registerShortcuts() {
	      ...
	      this.jqconsole.RegisterShortcut('A', function () {
	        return _this2.MoveToStart();
	      });

	      // Ctrl+E: Move terminal to the end.
	      this.jqconsole.RegisterShortcut('E', function () {
	        return _this2.MoveToEnd();
	      });

	      // Ctrl+K: Clear terminal.
	      this.jqconsole.RegisterShortcut('K', function () {
	        return _this2.Clear();
	      });
	    }
	  }, {
	    ...
	    value: function loadLanguage(language) {
	      ...
	      this.jsrepl.loadLanguage(language, function () {
	        _this4.toggleSpinner();
	        _this4.jqconsole = $('#console').jqconsole((0, _lang_configLanguage.languageSpec)(language) + '\n', '>>> ', '...');
	    ...
	    key: 'evaluateCode',
	    value: function evaluateCode(code) {
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(_componentsTerminalComponent2['default'], {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TerminalComponent = (function (_React$Component) {
	  ...
	  function TerminalComponent(props) {
	    ...
	    _get(Object.getPrototypeOf(TerminalComponent.prototype), 'constructor', this).call(this, props);
	  }

	  _createClass(TerminalComponent, [{
	    key: 'render',
	    value: function render() {
	      var showSpinner = this.props.showSpinner ? '' : 'none';
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'header',
	          { className: 'mdl-layout__header terminal-header' },
	          _react2['default'].createElement(
	            'div',
	            { className: 'mdl-layout__header-row' },
	            _react2['default'].createElement(
	              'button',
	              { className: 'mdl-button mdl-js-button terminal-editor-button', onClick: this.props.clearTerminal },
	              'clear'
	            )
	          )
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: "load7", style: { display: showSpinner } },
	          _react2['default'].createElement(
	            'div',
	            { className: 'loader' },
	            'Loading...'
	        ...
	        _react2['default'].createElement(
	          'footer',
	          { className: 'mdl-mini-footer mdl-cell mdl-cell--12-col footer' },
	          _react2['default'].createElement('div', { className: 'mdl-mini-footer__left-section' })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	*/
	...
	exports.languageSpec = languageSpec;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsMarkdownComponent = __webpack_require__(200);

	var _componentsMarkdownComponent2 = _interopRequireDefault(_componentsMarkdownComponent);
	...
	var MarkdownContainer = (function (_React$Component) {
	  ...
	  function MarkdownContainer(props) {
	    ...
	    _get(Object.getPrototypeOf(MarkdownContainer.prototype), 'constructor', this).call(this, props);
	    this.md;
	    this.state = {
	      text: ""
	    };
	  ...
	  _createClass(MarkdownContainer, [{
	    ...
	    key: 'preventLinksFromOpening',
	    value: function preventLinksFromOpening(e) {
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(_componentsMarkdownComponent2['default'], {
	        markdown: this.md,
	...
	exports['default'] = MarkdownContainer;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MarkdownComponent = (function (_React$Component) {
	  ...
	  function MarkdownComponent(props) {
	    ...
	    _get(Object.getPrototypeOf(MarkdownComponent.prototype), 'constructor', this).call(this, props);
	  }
	  ...
	  _createClass(MarkdownComponent, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'header',
	          { className: 'mdl-layout__header markdown-header' },
	          _react2['default'].createElement('div', { className: 'mdl-layout__header-row' })
	        ),
	        _react2['default'].createElement('div', { className: 'markdown-body',
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var DraggableDiv = (function (_React$Component) {
	  _inherits(DraggableDiv, _React$Component);

	  function DraggableDiv(props) {
	    _classCallCheck(this, DraggableDiv);

	    _get(Object.getPrototypeOf(DraggableDiv.prototype), 'constructor', this).call(this, props);
	    this.x_pos = 0;
